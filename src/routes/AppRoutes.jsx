    ...
    <>
      ...
      <main style={{ minHeight: "calc(100vh - var(--navbar-height))" }}>
        <Routes>
          ...
          <Route path="/seller/gigs/create" element={
            <ProtectedRoute role="seller"><CreateGig /></ProtectedRoute>
          } />
          <Route path="/seller/gigs/edit/:id" element={
            <ProtectedRoute role="seller"><EditGig /></ProtectedRoute>
          } />
          ...
          <Route path="/orders/:id/pay" element={
            <ProtectedRoute role="buyer"><Payment /></ProtectedRoute>
          } />
